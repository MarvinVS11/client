...
export  function RegisterForm(props) {
    ...
    const formik= useFormik({
        ...
        validationSchema: validationSchema(),//Validaciones de campos
  ...
  return (
    <Form className='register-form' onSubmit={formik.handleSubmit}>
       <Form.Input name="email" placeholder ="Correro electronico" onChange={formik.handleChange} value={formik.values.email} error={formik.errors.email}/>
       ...
       <Form.Checkbox name = 'conditionsAccepted' label="He leido las politicas de privacidad" onChange={(_, data)=>{
        formik.setFieldValue("conditionsAccepted", data.checked)
       }}
       checked={formik.values.conditionsAccepted}error={formik.errors.conditionsAccepted}/>
